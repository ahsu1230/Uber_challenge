...
File Directory:
    ...
    GraphHandler.py		- Handles Truck instances & calculating nearby trucks
    test_DistanceCalculator.py 	- Test file for calculating distances
    test_xmlparser.py	   	- Test file for XML parser
    test_GraphHandler.py	- Test file for GraphHandler.py
...
Technical Choices: Google App Engine, Python, Google Maps API
    ...
    I chose Python because it is the most familiar language 
